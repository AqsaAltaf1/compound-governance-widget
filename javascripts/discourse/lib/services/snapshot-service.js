...
export async function fetchSnapshotProposal(
  ...
  try {
    console.log(
      "🔵 [SNAPSHOT] Fetching proposal - space:",
      space,
      "proposalId:",
      proposalId,
      "isTestnet:",
    ...
    const fullProposalId4 = isTestnet
      ? `${spaceWithoutPrefix}/${proposalId}`
      : null;
